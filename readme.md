...
This project was developed as a portfolio application to demonstrate full-stack web development, user authentication, persistent game data, API design, and communication between a modern single-page application and a C# backend.
